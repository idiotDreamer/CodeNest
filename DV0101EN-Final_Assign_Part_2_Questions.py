...
chart4 = dcc.Graph(
            figure=px.bar(unemployment_effect, x='Year', y='Unemployment_Rate', color='Vehicle_Type', barmode='group', title="Effect of Unemployment Rate on Vehicle Type and Sales")
        )
return [
          ...
          avr_vdata=data.groupby('Vehicle')['Automobile_Sales'].mean().reset_index()
          print(avr_vdata)
          ...
          exp_data=yearly_data.groupby('Vehicle')['Advertising_Expenditure'].sum().reset_index()
